...
```{r echo=FALSE}
knitr::include_graphics("images/bookdown-edit.png")
```

You'll be directed to GitHub, and asked to fork the repository. Click _Fork this repository and propose changes_.

```{r echo=FALSE}
knitr::include_graphics("images/bookdown-fork.png")
```

Make your changes in the _Edit file_ editor.

```{r echo=FALSE}
knitr::include_graphics("images/bookdown-github-edit.png")
```

Then, scroll down to the box titled _Propose file change_.

```{r echo=FALSE}
knitr::include_graphics("images/bookdown-pull-request.png")
```

Add a title and description to your proposed change.

```{r echo=FALSE}
knitr::include_graphics("images/bookdown-pull-request-description.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("images/bookdown-pull-request-compare.png")
```

You'll again have a change to edit your pull request title and description. 

```{r echo=FALSE}
knitr::include_graphics("images/bookdown-pull-request-description-2.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("images/bookdown-pull-request-done.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("images/tree-correct.png")
```

Not like this

```{r echo=FALSE}
knitr::include_graphics("images/tree-wrong.png")
```
...
Next, you'll need to repeat the steps from _Make changes in your branch_ on. 
