...
knitr::include_graphics("images/preferences_wizard.png")
```
...
```{r echo=FALSE, image_dpi = 125}
knitr::include_graphics("images/tv_snippet.png")
```
...
```{r echo=FALSE, image_dpi = 125}
knitr::include_graphics("images/rscript_snippet.png")
```
...
```{r echo=FALSE, image_dpi = 125}
knitr::include_graphics("images/rscript_snippet_done.png")
``` 
...
```{r echo=FALSE, image_dpi = 125}
knitr::include_graphics("images/rscript_snippet_popup.png")
```
